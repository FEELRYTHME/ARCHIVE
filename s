...
I can't downgrade the games, guys. i don't have versions v1.1116 too, Hope you understand. I Just can make it the game version i have (The Latest will be priority for me).
i check old archive and everything, some line coloms and evryhting could be different for every single version, 
that's why you can't use the same type versions (Will Be Stuck, Black Screen issue, Crash etc).

For late notice, 
the last files i got really better than the oldest.
